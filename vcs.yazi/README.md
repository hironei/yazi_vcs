...
- For SVN, valid percent-encoded UTF-8 in the repository-root URL is decoded for readable Unicode output. The local relative target path is appended as-is; encoded delimiters and malformed escapes are preserved.
